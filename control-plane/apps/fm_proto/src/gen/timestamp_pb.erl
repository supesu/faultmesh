...
-export_type(['google.protobuf.Timestamp'/0]).
-type '$msg_name'() :: 'google.protobuf.Timestamp'.
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of 'google.protobuf.Timestamp' -> 'encode_msg_google.protobuf.Timestamp'(id(Msg, TrUserData), TrUserData) end.
...
merge_msgs(Prev, New, MsgName, Opts) ->
    TrUserData = proplists:get_value(user_data, Opts),
    case MsgName of 'google.protobuf.Timestamp' -> 'merge_msg_google.protobuf.Timestamp'(Prev, New, TrUserData) end.
...
get_msg_defs() -> [{{msg, 'google.protobuf.Timestamp'}, [#{name => seconds, fnum => 1, rnum => 2, type => int64, occurrence => optional, opts => []}, #{name => nanos, fnum => 2, rnum => 3, type => int32, occurrence => optional, opts => []}]}].


get_msg_names() -> ['google.protobuf.Timestamp'].


get_group_names() -> [].


get_msg_or_group_names() -> ['google.protobuf.Timestamp'].
...
source_basename() -> "timestamp.proto".
...
get_all_source_basenames() -> ["timestamp.proto"].
